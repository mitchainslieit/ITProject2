                                ...
                                <div class="misc-fee">
                                  <?php 
                                    foreach($run->getNameOfStud() as $row) {
                                       extract($row);
                                       if ($stud_status === 'Officially Enrolled' OR $stud_status === 'Temporarily Enrolled') {
                                        echo '<span class="wlrno" data-lrno="'.$stud_lrno.'"><b>Miscellaneous Fee: '.$run->getMiscellaneousFee().'</b></span>';
                                       } else {
                                        echo '<span class="wlrno" data-lrno="'.$stud_lrno.'"><b>Miscellaneous Fee: No Miscellaneous Fee yet</b></span>';
                                       }
                                       /*echo '
                               ...
                               <div id="children-totals">
                                <div class="container">
                                    <div class="customContent">
                                       <b>LRN Number: </b><?php $run->getLRNOfStud(); ?><br>
