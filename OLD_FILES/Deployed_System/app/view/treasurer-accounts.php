				...
				<div class="widgetContent">
					<div class="cont1">
						...
						<select name="year_level" class="year_level">
							...
							<?php
							foreach($run->getSectionAccount() as $row){
								extract($row);
								echo '<option value="'.$row['grade_lvl'].'-'.$row['sec_name'].'">'.$row['grade_lvl'].'-'.$row['sec_name'].'</option>';
							}
							?>
						</select>
					</div>
					<div class="cont1">
						...
						<select name="bal_status" class="year_level">
							...
							<?php
							foreach($run->getStatusInfo() as $row){
								extract($row);
								echo '<option value="'.$row['bal_status'].'">'.$row['bal_status'].'</option>';
							}
							?>
						</select>
					</div>
		...
		<div class="content">
			<div class="column left">
				<div id="columncontent">
					...
					<p><span class="bold">Section: </span>&nbsp;'.$full_secname.'</p> <br>
						...
						<div class="table-scroll">	
							<div class="table-wrap">	
								<table>
									...
									<?php 
									foreach($run->getBreakdownOfFee() as $row) {
										extract($row);
										echo '
										<tr>
										<td> '.$budget_name.' </td>
