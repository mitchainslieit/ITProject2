...
switch($page[0]) {
	case 'superadmin' :
		...
		echo '<li '.$this->helpers->isActiveMenu("superadmin-sum").'><a href="'.URL.'superadmin-sum"><i class="fas fa-user-edit fnt"></i>Student Status</a></li>';
		echo '</ul>';
		echo '<li>';
	...
	case 'faculty' : 
		...
		if($_SESSION['enroll_privilege'] === 'Yes') {
		...
		if ($_SESSION['adviser'] === 'Yes') {
			echo '<li>';
			echo '<a href="'.' '.'" target="advisory-student-submenu" class="submenu-title"><span><i class="fas fa-user-friends"></i>Advisory<i class="fa fa-angle-left pull-right"></i></span></a>';
			echo '<ul class="sidebar-submenu" id="advisory-student-submenu">';
			...
			if ($_SESSION['transfer_enabled'] === 'Yes') {
				echo '<li '.$this->helpers->isActiveMenu("faculty-student-transfer").'><a href="'.URL.'faculty-student-transfer"><i class="fas fa-user-edit"></i>Transfer Students</a></li>';
			}
			echo '</ul>';
			echo '</li>';
		}
		...
		echo '<li '.$this->helpers->isActiveMenu("faculty-classes").'><a href="'.URL.'faculty-classes"><i class="fas fa-chalkboard-teacher"></i>Schedule</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("faculty-classes-students").'><a href="'.URL.'faculty-classes-students"><i class="far fa-list-alt"></i>Students Handled</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("faculty-classes-postannouncements").'><a href="'.URL.'faculty-classes-postannouncements"><i class="fas fa-bullhorn"></i>Create Announcements</a></li>';
		echo '</ul>';
		echo '</li>';
		if ($_SESSION['sec_privilege'] === 'Yes' && $_SESSION['editclass'] === 'Yes') {
			echo '<li '.$this->helpers->isActiveMenu("faculty-editclass").'><a href="'.URL.'faculty-editclass"><i class="fas fa-edit"></i>Edit Schedules</a></li>';
		}
		...
		/*if ($_SESSION['adviser'] === 'Yes') {
			echo '<li>';
			echo '<a href="'.' '.'" target="grades-submenu" class="submenu-title"><span><i class="fas fa-star-half-alt"></i>Academic Performance<i class="fa fa-angle-left pull-right"></i></span></a>';
			echo '<ul class="sidebar-submenu" id="grades-submenu">';
			echo '<li '.$this->helpers->isActiveMenu("faculty-grades").'><a href="'.URL.'faculty-grades"><i class="fas fa-star"></i>Grades And Core Values</a></li>';
			echo '<li '.$this->helpers->isActiveMenu("faculty-grades-history").'><a href="'.URL.'faculty-grades-history"><i class="fas fa-history"></i>History of Grades</a></li>';
			echo '</ul>';
			echo '</li>';
		} else {
			echo '<li>';
			echo '<a href="'.' '.'" target="grades-submenu" class="submenu-title"><span><i class="fas fa-star-half-alt"></i>Academic Performance<i class="fa fa-angle-left pull-right"></i></span></a>';
			echo '<ul class="sidebar-submenu" id="grades-submenu">';
			echo '<li '.$this->helpers->isActiveMenu("faculty-grades").'><a href="'.URL.'faculty-grades"><i class="fas fa-star"></i>Grades</a></li>';
			echo '<li '.$this->helpers->isActiveMenu("faculty-grades-history").'><a href="'.URL.'faculty-grades-history"><i class="fas fa-history"></i>History of Grades</a></li>';
			echo '</ul>';
			echo '</li>';
		}*/
	...
	case 'student' :
		...
		echo '<li '.$this->helpers->isActiveMenu("student-accounts").'><a href="'.URL.'student-accounts"><i class="fas fa-money-bill"></i>Statement of Accounts</a></li>';
		...
		echo '<li '.$this->helpers->isActiveMenu("student-grades-history").'><a href="'.URL.'student-grades-history"><i class="fas fa-history"></i>Transcript of Records</a></li>';
		echo '</ul>';
		echo '</li>';*/
	...
	case 'parent' :
		...
		echo '<li '.$this->helpers->isActiveMenu("parent-grades-history").'><a href="'.URL.'parent-grades-history"><i class="fas fa-history"></i>Transcript of Record</a></li>';
		echo '</ul>';
		echo '</li>';*/
	...
	case 'treasurer':
		...
		echo '<li '.$this->helpers->isActiveMenu("treasurer-accounts").'><a href="'.URL.'treasurer-accounts"><i class="fas fa-money-bill fnt"></i>Statement of Account</a></li>';
		...
		echo '<li>';
		echo '<a href="'.' '.'" target="soa-submenu" class="submenu-title"><span><i class="fab fa-blogger-b fnt"></i>Reports<i class="fa fa-angle-left pull-right"></i></span></a>';
		echo '<ul class="sidebar-submenu" id="soa-submenu">';
		echo '<li '.$this->helpers->isActiveMenu("treasurer-balance").'><a href="'.URL.'treasurer-balance"><i class="fas fa-user-edit"></i>Payment Transaction</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("treasurer-reports").'><a href="'.URL.'treasurer-reports"><i class="fas fa-history"></i>History of Fee Type</a></li>';
		echo '</ul>';
		echo '</li>';
		break;
	case 'admin':
		...
		echo '<li '.$this->helpers->isActiveMenu("admin-requests").'><a href="'.URL.'admin-requests"><i class="far fa-envelope fnt"></i>Notifications</a><span class="admin-notif">'.$_SESSION['adminNotif'].'</span></li>';
		echo '<li>';
		echo '<a href="'.' '.'" target="soa-submenu" class="submenu-title"><span><i class="fas fa-money-bill fnt"></i>Statement Of Accounts<i class="fa fa-angle-left pull-right"></i></span></a>';
		echo '<ul class="sidebar-submenu" id="soa-submenu">';
