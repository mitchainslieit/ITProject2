...
class FacultyFunct {
	...
	public function numOfStud() {
		$query = $this->conn->query("SELECT CONCAT('Grade', ' - ', year_level) as 'Year Level', COUNT(CASE WHEN gender = 'Male' THEN 1 END) AS 'Male Students', COUNT(CASE WHEN gender = 'Female' THEN 1 END) AS 'Female Students', COUNT(year_level) AS 'Total Student Count' FROM student GROUP BY year_level ORDER BY year_level");
		$result = $query->fetchAll();
		foreach ($result as $row) {
			echo '<tr>';
	...
	public function enrollNewStudent($post) {
		...
		} else if (strlen($post['guar_mobno']) < 11 || strlen($post['guar_mobno']) > 11) {
			$this->others->Message('Error!', 'You\'ve entered a wrong guadian mobile number', 'error', 'faculty-enroll');
		} else {
	...
	public function requestChange($post){
		if(isset($post['students'])) {
			...
			$this->others->Message('Success!,', 'Your request has been sent', "success", "faculty-student");
		} else {
	...
	public function showSections_temp() {
		$sql = $this->conn->query("SELECT * FROM section_temp ORDER BY gr_lvl, s_name");
		$result = $sql->fetchAll();
		$option = '';
		foreach ($result as $row) {
	...
	public function sendRequestToAdminForSched() {
		$getAllSec = $this->conn->query("SELECT *, CONCAT('Grade ',' ',gr_lvl,' - ',s_name) as 'section_name' FROM section_temp");
    		...
    		foreach ($student as $stud) {
    			...
    			if($active_grading != '4th'){
    				if($active_grading === '1st'){
    					echo '<td>'.$stud['Name'].'</td>';
    					if($grade_1st === '') {
    						echo '<td class="first_td"><input type="text" name="first[]")></td>';
    					} else {
    						echo '<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? 'value="'.$grade_1st.'"' : '').'>
    					</td>';
    					}
    					echo '<td></td>';
    					echo '<td></td>';
    				...
    				if($active_grading === '2nd'){
    					echo '<td>'.$stud['Name'].'</td>';
				 		if($grade_2nd === ''){
							echo '
							<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_1st.'"').'></td>
							<td class="second_td"><input type="text" name="second[]" '.(!empty($grade_active) ? 'value="'.$grade_active.'"' : '').'></td>';
					}else {
						echo '<td class="first_td"> <input type="text" name="first[]" '.(!empty($grade_active) ? 'value="'.$grade_1st.'"' : '').'>
							</td>
								<td class="second_td"> <input type="text" name="second[]" '.(!empty($grade_active) ? 'value="'.$grade_2nd.'"' : '').'>
							</td>';
					}
						echo '<td></td>';
						echo '<td></td>';	
    				...
    				if($active_grading === '3rd') {
    					echo '<td>'.$stud['Name'].'</td>';
				 		if($grade_3rd === ''){
							echo '
							<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_1st.'"').'></td>
							<td class="second_td"><input type="text" name="second[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_2nd.'"').'></td>
							<td class="third_td"><input type="text" name="third[]" '.(!empty($grade_active) ? 'value="'.$grade_active.'"' : '').'></td>';
					}else {
						echo '<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? 'value="'.$grade_1st.'"' : '').'>
							</td>
							<td class="second_td"><input type="text" name="second[]" '.(!empty($grade_active) ? 'value="'.$grade_2nd.'"' : '').'>
							</td>
							<td class="third_td"><input type="text" name="third[]" '.(!empty($grade_active) ? 'value="'.$grade_3rd.'"' : '').'>
							</td>';
					}
						echo '<td></td>';	
    				}
    				...
    				if($grade_4th === ''){
    					echo '
							<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_1st.'"').'></td>
							<td class="second_td"><input type="text" name="second[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_2nd.'"').'></td>
							<td class="third_td"><input type="text" name="third[]" '.(!empty($grade_active) ? '' : 'value="'.$grade_3rd.'"').'></td>
							<td class="fourth_td"><input class="fourth_qtr" type="text"  name="fourth[]" '.(!empty($grade_active) ? 'value="'.$grade_active.'"' : '').'></td>
								<td><input type="text" name="remarks[]" class="remarks" '.(!empty($remarks_active) ? 'value="'.$remarks_active.'"' : '').'>	
    								</td>';
    				} else{
    					echo '
							<td class="first_td"><input type="text" name="first[]" '.(!empty($grade_active) ? 'value="'.$grade_1st.'"' : 'value="'.$grade_1st.'"').'></td>
							<td  class="second_td"><input type="text" name="second[]" '.(!empty($grade_active) ? 'value="'.$grade_2nd.'"' : 'value="'.$grade_2nd.'"').'></td>
							<td class="third_td"><input type="text" name="third[]" '.(!empty($grade_active) ? 'value="'.$grade_3rd.'"' : 'value="'.$grade_3rd.'"').'></td>
							<td class="fourth_td"><input class="fourth_qtr" type="text"  name="fourth[]" '.(!empty($grade_active) ? 'value="'.$grade_4th.'"' : (!empty($remarks_active) ? 'value="INC"' : '')).'></td>
	...
	private function createSectionTable($row) {
		...
		$schedInfo1 = $getSchedInfo($time_start[0], $row['sectionid']);
		$schedInfo2 = $getSchedInfo($time_start[1], $row['sectionid']);
		$schedInfo3 = $getSchedInfo($time_start[2], $row['sectionid']);
		$schedInfo4 = $getSchedInfo($time_start[3], $row['sectionid']);
		$schedInfo5 = $getSchedInfo($time_start[4], $row['sectionid']);
		$schedInfo6 = $getSchedInfo($time_start[5], $row['sectionid']);
		$schedInfo7 = $getSchedInfo($time_start[6], $row['sectionid']);
		...
		$createForm = function($details, $time_start) {
			$getLvl = $this->conn->prepare("SELECT gr_lvl FROM section_temp WHERE sectionid = :sec_id");
			$getLvl->execute(array(
				':sec_id' => $details['sec_id']
			));
			$resultLvl = $getLvl->fetch();
			$grade = $resultLvl['gr_lvl'];
			$getCur = $this->conn->query("SELECT current_curriculum as 'cur' FROM system_settings WHERE sy_status = 'Current'");
			$resultCur = $getCur->fetch();
			$cur = $resultCur['cur'];
				...
				<table class="classes-sched">
					...
					<tbody>
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo1['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo1['sched_id'], $schedInfo1['subj_id'], $time_start[0], $schedInfo1['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo1['sched_id'], $schedInfo1['subj_id'], $time_start[0], $schedInfo1['fac_id']), $time_start[0]).'
									</div>
								</div>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo2['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo2['sched_id'], $schedInfo2['subj_id'], $time_start[1], $schedInfo2['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo2['sched_id'], $schedInfo2['subj_id'], $time_start[1], $schedInfo2['fac_id']), $time_start[1]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo3['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo3['sched_id'], $schedInfo3['subj_id'], $time_start[2], $schedInfo3['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo3['sched_id'], $schedInfo3['subj_id'], $time_start[2], $schedInfo3['fac_id']), $time_start[2]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo4['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo4['sched_id'], $schedInfo4['subj_id'], $time_start[3], $schedInfo4['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo4['sched_id'], $schedInfo4['subj_id'], $time_start[3], $schedInfo4['fac_id']), $time_start[3]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo5['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo5['sched_id'], $schedInfo5['subj_id'], $time_start[4], $schedInfo5['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo5['sched_id'], $schedInfo5['subj_id'], $time_start[4], $schedInfo5['fac_id']), $time_start[4]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo6['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo6['sched_id'], $schedInfo6['subj_id'], $time_start[5], $schedInfo6['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo6['sched_id'], $schedInfo6['subj_id'], $time_start[5], $schedInfo6['fac_id']), $time_start[5]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
						...
						<tr>
							...
							<td width="10%" class="buttons">'.($schedInfo7['subject'] !== 'Unassigned' ? $remove($createSchedData($row['sectionid'], $schedInfo7['sched_id'], $schedInfo7['subj_id'], $time_start[6], $schedInfo7['fac_id'])) : '').' 
								<div name="dialog" title="Edit Schedule">
									<div class="container">
										'.$createForm($createSchedData($row['sectionid'], $schedInfo7['sched_id'], $schedInfo7['subj_id'], $time_start[6], $schedInfo7['fac_id']), $time_start[6]).'
									</div>
								</div>
								<button type="button" name="opener" class="edit-status btn-primary btn" data-type="open-dialog"><span class="tooltip edit" title="Edit this schedule"><i class="far fa-edit"></i></span></button>
							</td>
	...
	public function updateProfile($prof_pic){		
		...
		if($type=='image/jpg' || $type=='image/jpeg' || $type=='image/png' || $type=='image/gif' || $type=='application/pdf'  || $type=='audio/mpeg' || $type=='audio/mpeg3' || $type=='audio/x-mpeg' || $type=='audio/x-mpeg-3') {	
			if(!file_exists($pathWithFile)){
				if($size < 5000000){
					...
					if($sql3->execute(array(
						...
						$this->alert("Error!", "You have successfully changed your profile picture", "error", "faculty-profile");
					}
				}else{
