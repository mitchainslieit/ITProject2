	<?php require 'app/model/parent_funct.php'; $obj = new ParentFunct;?>
	<?php 
	...
	?>
<?php foreach($obj->parentDetails() as $value){
	extract($value);
	echo'
		...
		<div class="row rowProf">
			<div class="nameCont">
				<div name="content" id="changeProfileCont">
					...
					<div name="dialog" title="Change Profile">
						<form action="parent-profile" method="POST" enctype="multipart/form-data">
				...
				<div name="content">
					...
					<div name="dialog" title="Change Password">
						...
						<form action="parent-profile" method="post" autocomplete="off">
							<div class="inputs">
								<div class="password">
			...
			<div class="widget">
				<div class="widgetcontent">
					<div class="box box1">
						<span>Address:</span>
						<input type="text" value="'.$guar_address.'" disabled>
					</div>
					<div class="box box2">
						<span>Mobile Number:</span>
						<input type="text" value="'.$guar_mobno.'" disabled>
					</div>
					<div class="box box3">
						<span>Guardian Telephone Number:</span>
						<input type="text" value="'.$guar_telno.'" disabled>
					</div>
				</div>
			</div>
		</div>
