<?php require 'app/model/treasurer_func.php'; $run= new TreasurerFunc ?>
	...
	?>
<?php foreach($run->tresDetails() as $value){
	extract($value);
	echo'
		...
		<div class="row rowProf">
			<div class="nameCont">
				<div name="content" id="changeProfileCont">
					...
					<div name="dialog" title="Change Picture">
						<form action="treasurer-profile" method="POST" enctype="multipart/form-data">
				...
				<div name="content">
					...
					<div name="dialog" title="Change Password">
						...
						<form action="treasurer-profile" method="post" autocomplete="off">
							<div class="inputs">
								<div class="password">
			...
			<div class="widget">
				<div class="widgetcontent">
					<div class="box box1">
						<span>Current PTA for school year: </span>
						<input type="text" value="'.$tr_sy.' - '.((int) $tr_sy + 1).'" disabled>
					</div>
				</div>
			</div>
		</div>
