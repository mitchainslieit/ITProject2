	<?php /*profile*/ require 'app/model/Superadmin-funct.php'; $obj = new SAdminFunct;?>
	<?php 
			...
			<div class="nameCont">
				<div name="content" id="changeProfileCont">
					...
					<div name="dialog" title="Change Picture">
						<form action="superadmin-profile" method="POST" enctype="multipart/form-data">
				...
				<div name="content">
					...
					<div name="dialog" title="Change Password">
						...
						<form action="superadmin-profile" method="post" autocomplete="off">
							<div class="inputs">
								<div class="password">
