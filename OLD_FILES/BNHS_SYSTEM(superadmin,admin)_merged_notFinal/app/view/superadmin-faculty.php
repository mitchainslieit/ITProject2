		...
		<div class="row">
			<div class="widget">	
				...
				<div class="widgetContent facultyContent">
					<div class="cont1">
						<div name="content">
							...
							<div name="dialog" title="Create new faculty account">
								<form action="superadmin-faculty" method="POST" autocomplete="off">
					...
					<div class="cont2">
						<form action="superadmin-faculty" method="POST" id="form1"></form>
 	...
 	<td class="action">
 		<div name="content">
			...
			<div name="dialog" title="Update faculty data">
				<form action="superadmin-faculty" method="POST" required autocomplete="off" class="validateChangesInForm">
		...
		<div name="content">
			...
			<div name="dialog" title="Delete faculty account">
				<form action="superadmin-faculty" method="POST" required>
		...
		<div name="content">
			...
			<div name="dialog" title="Change Status">
				<form action="superadmin-faculty" method="POST" required class="validateChangesInForm">
