		...
		<div class="row">
			<div class="widget">	
				...
				<div class="widgetContent curriculumContent">
					<div class="cont1">
						<div name="content">
							<a href="superadmin-curriculum" class="customButton">Add curriculum <i class="fas fa-plus fnt"></i></a>
						</div>
					</div>
					<br>
					<div class="cont2">
						...
						<form action="superadmin-subjects" method="POST" id="form1"></form>
	...
	?>
			...
			<div class="widget SubjectWidgetHide hidden">	
				<div class="header">	
					<div class="cont">	
						<i class="fas fa-money-check"></i>
...
?>								
						...
						<table id="superadmin-table-curriculum2" class="display"style="width: 100% !important;">
							<thead>
								<tr>
									<th>Curriculum</th>
