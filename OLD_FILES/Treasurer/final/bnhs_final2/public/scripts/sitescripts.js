...
$( document ).ready(function() {
    ...
    var datatable = $( "#stud-list, #adv-table-1, #adv-table-2, #treasurer-table-1, #treasurer-table-2" ).DataTable({
        dom: "lBfrtip",
        buttons: [
            'excel','pdf','print'
        ],
    ...
    $( '#treasurer_home .contentpage .widget .eventcontent .cont1 select' ).on('change', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'app/model/treasurer-stud-list.php',
            data: data,
            success: function(result) {
                $('#treasurer_home .contentpage .widget .eventcontent .treasurer-table-2-class').load('treasurer-accounts #treasurer-table-2', function() {
                    $.getScript("public/scripts/sitescripts.js"); 
                });
            }
        });
    });
