								...
								<div class="table-scroll">
									...
									<div class="show">
										...
										<select id="filter-stud-list-transfers">
											...
											<option value="Transfered">Tranfered</option>
										</select>
									</div>
									<div class="table-wrap">
									...
									<div id="auto-fill">
										<div class="form-row par-guar">
											...
											<div class="parents-info">
												<p class="note"><span class="required">Note:</span> For parents/guardians with one (1) or more children that is already enrolled  kindly click the <span class="required">"Existing"</span> button.</p>
												<label>
											...
											<label>
												...
												<?php if(!is_array($info)) { ?>
													<input type="text" name="guar_mobno" placeholder="ex. 09000000000" data-validation="length" data-validation="number" data-validation-length="11" data-validation-error-msg="It is not a valid cellphone number" required>
												<?php } else { ?>
