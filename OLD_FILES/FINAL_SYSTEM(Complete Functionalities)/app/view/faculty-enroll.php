								...
								<div class="table-scroll">
									<div class="show">
										...
										<select id="filter-stud-list-remarks">
											...
											<option value="For Summer">Students for Summer</option>
										</select>
									</div>
								...
								<form action="faculty-enroll" class="enrollment-form" id="student-enrollment-form" method="POST">
									<div class="form-row">
										...
										<label>
											...
											<input type="text" minlength="13" maxlength="13" name="stud_lrno" oninvalid="setCustomValidity('Please enter a valid LR Number')" onchange="try{setCustomValidity('')}catch(e){}" pattern="[0-9]{13}" required>
										</label>
										<label>
									...
									<div id="auto-fill">
										<div class="form-row par-guar">
											...
											<label>
												...
												<?php if(!is_array($info)) { ?>
													<input type="text" name="guar_mobno" maxlength="11" pattern="[0-9]{11}" placeholder="ex. 09000000000" oninvalid="setCustomValidity('Please enter a valid mobile number')" onchange="try{setCustomValidity('')}catch(e){}" required>
												<?php } else { ?>
