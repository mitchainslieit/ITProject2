						...
						<div id="section1">
							...
							<div class="cont3">
								<div class="table-scroll">
									...
									<div class="show">
										<label>Show Transferred Students: </label>
								...
								<form action="faculty-enroll" class="enrollment-form" id="student-enrollment-form" method="POST">
									<div class="form-row">
										...
										<label>
											...
											<input type="text" name="stud_lrno" data-sanitize="capitalize" data-validation="length" data-validation="number" data-validation-length="13" data-validation-error-msg="Your input is an invalid LRN Number" required>
										</label>
										<label>
												...
												<label>
													...
													<div class="par-inp">
														<?php if(!is_array($info)) { ?>
															...
															<input type="text" name="fathername_middle_name" data-sanitize="capitalize" placeholder="Middle Initial">
												...
												<label>
													...
													<div class="par-inp">
														<?php if(!is_array($info)) { ?>
															...
															<input type="text" name="mothername_middle_name" data-sanitize="capitalize" placeholder="Middle Initial">
												...
												<label>
													...
													<div class="par-inp">
														<?php if(!is_array($info)) { ?>
															...
															<input type="text" name="guar_middle_name" data-sanitize="capitalize" placeholder="Middle Initial">	
