	...
	<?php 
		if (isset($_POST['submit-bttn'])) {
	        ...
	        $getFactFunct->enrollNewStudent( $_POST['yearlevel'],  $_POST['lrn'],  $_POST['lastname'],  $_POST['firstname'],  $_POST['middlename'],  $_POST['birthday'],  $_POST['gender'],  $_POST['address'],  $_POST['barangay'],  $_POST['city'],  $_POST['zipcode'],  $_POST['fathername'],  $_POST['mothername'],  $_POST['guardname'],  $_POST['telno'],  $_POST['cellno'], $_POST['enroll-status']);
	    }
	?>
