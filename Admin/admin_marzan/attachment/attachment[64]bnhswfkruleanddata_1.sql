...
INSERT INTO `parent` VALUES (1,'Julina May','Gaddi','Jugo','Asin Baguio City ','2019-03-31 03:22:36',4),(2,'Dom Christian Jay','Nimes','Fernandez','Dagsian Baguio City','2019-03-31 03:22:36',5);
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `pr_id` FOREIGN KEY (`pr_id`) REFERENCES `parent` (`pr_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `student` VALUES (1,2019087065345,'Marzan','Mark Kenneth','Pagar   ','Male','10',2019,NULL,'Queen of Peace Baguio City','1999-10-22','',NULL,NULL,NULL,'Filipino','Igorot',2015,NULL,'O','Skin Allergy','Officially Enrolled','Old','0000-00-00 00:00:00',3,7,1),(2,2019087065675,'Cantero','Mark Israel ','Asuncion','','9',2019,NULL,'Bakakeng Sur Baguio City','0000-00-00',NULL,NULL,NULL,NULL,'Filipino','Tagalog',2016,NULL,'AB','None','Officially Enrolled','New','0000-00-00 00:00:00',6,6,2);
...
-- Dump completed on 2019-04-09 13:55:13
