		...
		<div class="row">
			<div class="widget">	
				...
				<div class="widgetContent studentContent">
					...
					<div class="cont2">
						<form action="superadmin-student" method="POST" id="form1"></form>
						<table id="superadmin-table-student" class="display" width="100%">
							<thead>
								<tr>
	...
	<td class="action">
		<div name="content">
			...
			<div name="dialog" title="Change Status">
				<form action="superadmin-student" method="POST" required class="validateChangesInForm">
		...
		<div name="content">
			...
			<div name="dialog" title="Reset Password">
				<form action="superadmin-student" method="POST" required>
					<input type="hidden" value="'.$acc_id.'" name="acc_id">
